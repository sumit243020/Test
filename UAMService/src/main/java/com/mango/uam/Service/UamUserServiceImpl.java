...
//		return  ResponseEntity.of(Optional.of(uamUser));
	...
	@Override
	public UamUserEntity findById(Long idUser) {
		
		return uamUserRepository.getById(idUser);
	}

	@Override
	public void delete(UamUserEntity uamUserEntity) {
		
		uamUserRepository.delete(uamUserEntity);
